...
class Scenarios(Account):
    ...
    async def _withdraw_to_okex(
        ...
        if bridge_tx_pending:
            ...
            if bridge_tx_pending["message_type"] == 2:  # вывод
                ...
                await self.scroll_ethereum.withdraw_claim(bridge_tx_pending)
    ...
    async def _buy_and_withdraw_eth(self, amount: float, wait_withdrawal=False, include_fee=False):
